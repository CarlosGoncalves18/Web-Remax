<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="message.aspx.cs" Inherits="prjWebRemax.GUI.message" %>
        ...
        <section class="message">
            ...
            <table class="auto-style3" align="center">
                ...
                <tr>
                    ...
                    <td>
                         <asp:DropDownList ID="cboRecipient" runat="server" Height="53px" Width="489px" AutoPostBack="True">
                         </asp:DropDownList>
                    </td>
                </tr>
                <tr>
